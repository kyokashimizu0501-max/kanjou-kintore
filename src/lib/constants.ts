export const EMOTION_TYPES = [
  ...
  },
  {
    ...
    advice: "できることに集中し、できないことは手放しましょう",
  },
  {
    id: "joy",
    label: "嬉しい・ワクワク",
...
export const SITUATION_TAGS = [
  { id: "work", label: "職場・仕事", emoji: "💼" },
  { id: "family", label: "家族・家庭", emoji: "🏠" },
  { id: "relationship", label: "友人・人間関係", emoji: "👥" },
  { id: "sns", label: "SNS・ネット", emoji: "📱" },
  { id: "money", label: "お金・生活", emoji: "💰" },
  { id: "self", label: "自分自身", emoji: "🪞" },
  { id: "other", label: "その他", emoji: "📌" },
] as const;

export const POST_ACTIONS = [
  { id: "binge_eating", label: "爆食いした", emoji: "🍔" },
  { id: "bad_mouthing", label: "悪口を言った", emoji: "🗯️" },
  { id: "withdrawal", label: "引きこもった", emoji: "🚪" },
  { id: "endured", label: "我慢した", emoji: "😶" },
  { id: "walked", label: "散歩した", emoji: "🚶" },
  { id: "talked", label: "誰かに話した", emoji: "🗣️" },
  { id: "cried", label: "泣いた", emoji: "😭" },
  { id: "focused_work", label: "仕事に集中した", emoji: "💻" },
  { id: "wrote_memo", label: "メモを書いた", emoji: "✍️" },
  { id: "did_nothing", label: "何もしなかった", emoji: "💤" },
  { id: "custom", label: "その他（自由記入）", emoji: "➕" },
] as const;
